function xl_board_key_cutouts_extrude_1_2_outline_fn(){
    return new CSG.Path2D([[87.5,-162],[87.5,-84.75]]).appendPoint([124.25,-84.75]).appendPoint([125,-77.75]).appendPoint([143,-77.75]).appendPoint([143.75,-72.75]).appendPoint([168.75,-72.75]).appendPoint([169.5,-78.75]).appendPoint([187.5,-78.75]).appendPoint([188.2501,-81.75]).appendPoint([206.25,-81.75]).appendPoint([206.25,-155.5]).appendPoint([232.25,-155.5]).appendPoint([232.25,-176.5]).appendPoint([213.5,-176.5]).appendPoint([213.5,-195.5]).appendPoint([191.5,-195.5]).appendPoint([191.5,-176.5]).appendPoint([172.75,-176.5]).appendPoint([172.75,-156]).appendPoint([162.5,-156]).appendPoint([161.75,-150]).appendPoint([150.75,-150]).appendPoint([150,-155]).appendPoint([132,-155]).appendPoint([131.25,-162]).appendPoint([87.5,-162]).close().innerToCAG()
.subtract(
    new CSG.Path2D([[195.5,-192],[209.5,-192]]).appendPoint([209.5,-178]).appendPoint([195.5,-178]).appendPoint([195.5,-192]).close().innerToCAG()
.union(
    new CSG.Path2D([[214.25,-173],[228.25,-173]]).appendPoint([228.25,-159]).appendPoint([214.25,-159]).appendPoint([214.25,-173]).close().innerToCAG()
).union(
    new CSG.Path2D([[195.5,-173],[209.5,-173]]).appendPoint([209.5,-159]).appendPoint([195.5,-159]).appendPoint([195.5,-173]).close().innerToCAG()
).union(
    new CSG.Path2D([[176.75,-173],[190.75,-173]]).appendPoint([190.75,-159]).appendPoint([176.75,-159]).appendPoint([176.75,-173]).close().innerToCAG()
).union(
    ...
    new CSG.Path2D([[186.75,-154],[200.75,-154]]).appendPoint([200.75,-140]).appendPoint([186.75,-140]).appendPoint([186.75,-154]).close().innerToCAG()
).union(
